...
class Doctor_Home_Screen extends StatefulWidget {
  const Doctor_Home_Screen({super.key});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'مجتمع التوحد',
            style: TextStyle(
                color: fontColor, fontWeight: FontWeight.bold, fontSize: 27),
          ),
        ),
        drawer: Drawer(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) {
                              return const Settings_Doctor_Screen();
                            }),
                          );
                        },
                        child: const Row(
        ...
        bottomNavigationBar: NavigationBarTheme(
          ...
          child: NavigationBar(
            ...
            destinations: [
              ...
              NavigationDestination(
                  icon: Icon(
                    _currentIndex == 2 ? Icons.reviews : Icons.reviews_outlined,
                    color: Color(0xffE1E2E9),
                  ),
                  label: 'إرشاد'),
            ],
