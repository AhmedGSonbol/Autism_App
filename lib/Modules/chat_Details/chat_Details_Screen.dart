                    ...
                    } else
                    {
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index)
                        {
                          ...
                          if(DateTime.now().difference( intl.DateFormat('EEE, dd MMM yyyy HH:mm:ss zzz','en').parse(cubit.messages_model!.messagesData[index].date!)).inHours < 24)
                          {
                            showTimeOnly = true;
                          }
                          else
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(intl.DateFormat(showTimeOnly == true ? 'hh:mm a' : 'yy/M/d').format(intl.DateFormat('EEE, dd MMM yyyy HH:mm:ss zzz','en').parse(model.date!)),
