      ...
      child: BlocConsumer<AppCubit,AppStates>(
        ...
        builder: (context, state)
        {
          ...
          return Scaffold(
            ...
            body: screens[cubit.currentNavBarIndex],
              ...
              child: NavigationBar(
                ...
                destinations: [
                  NavigationDestination(
                      icon: Icon(
                          cubit.currentNavBarIndex == 0 ? Icons.forum : Icons.forum_outlined,
                          color: Color(0xffE1E2E9)),
                      label: 'الرئيسية'),
                  NavigationDestination(
                      icon: Icon(
                          cubit.currentNavBarIndex == 1 ? Icons.chat : Icons.chat_outlined,
                          color: Color(0xffE1E2E9)),
                      label: 'تحدث'),
                  NavigationDestination(
                      icon: Icon(
                          cubit.currentNavBarIndex == 2
                              ? Icons.reviews
