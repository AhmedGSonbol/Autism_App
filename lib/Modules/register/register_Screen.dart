...
class Register_Screen extends StatelessWidget
{
  ...
  Widget build(BuildContext context)
  {
    ...
    [
      DoctorAccount1(formKey: formKey,),
      DoctorAccount2(formKey: formKey,),
      DoctorAccount3()
    ];
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              [
                ...
                Text(
                  cubit.currentRegScreen == 2 ? 'إكتمل إنشاء حسابك' :'إنشاء حساب جديد',
                  style: TextStyle(
                  ...
                  children: [
                    defaultButton(
                      ...
                      function: () {
                        ...
                        {
                          cubit.changeCurrentRegScreen(cubit.currentRegScreen + 1);
                        }
                      },
                    ),
                  ],
